...
const DreiImage: any = Image;
const TransmissionMaterial: any = MeshTransmissionMaterial;
...
const ModeWrapper = memo(function ModeWrapper({
  ...
  useEffect(() => {
    const geo = nodes[geometryKey]?.geometry as THREE.BufferGeometry | undefined;
    if (!geo) return;
...
function Images() {
  ...
  return (
    <group ref={group}>
      <DreiImage position={[-2, 0, 0]} scale={[3, height / 1.1, 1] as any} url="/assets/demo/cs1.webp" />
      <DreiImage position={[2, 0, 3]} scale={3 as any} url="/assets/demo/cs2.webp" />
      <DreiImage position={[-2.05, -height, 6]} scale={[1, 3, 1] as any} url="/assets/demo/cs3.webp" />
      <DreiImage position={[-0.6, -height, 9]} scale={[1, 2, 1] as any} url="/assets/demo/cs1.webp" />
      <DreiImage position={[0.75, -height, 10.5]} scale={1.5 as any} url="/assets/demo/cs2.webp" />
    </group>
  );
}
