    ...
    <div className="flex flex-col gap-4">
      <div
        className={cn(
          ...
          variant === "underline"
            ? cn("border-b", borderColor)
            : variant === "boxed"
              ? cn(bgColor, "border", borderColor, "rounded-xl p-1")
              : "gap-1",
        )}
      >
        {items.map((item) => {
          ...
          const variantClass =
            variant === "underline"
              ? cn(
                  ...
                  isActive
                    ? cn("border-blue-600", activeTextColor)
                    : cn("border-transparent", inactiveTextColor, `hover:${activeTextColor}`),
                )
              : variant === "pills"
                ? cn(
                    "rounded-full",
                    isActive
                      ...
                      : cn(inactiveTextColor, "hover:bg-gray-100"),
                  )
                : cn(
                    "rounded-lg",
                    isActive
