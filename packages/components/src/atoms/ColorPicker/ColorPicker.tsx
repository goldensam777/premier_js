    ...
    <div ref={ref} className="relative inline-flex flex-col gap-1">
      ...
      <button
        ...
        className={cn(
          ...
          "rounded-lg border-2",
          borderColor,
          "shadow-sm transition-transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed",
        )}
      ...
      {open && (
        <div
          className={cn(
            "fixed z-9999 w-64 rounded-2xl border",
            borderColor,
            bgColor,
            "shadow-xl p-4 flex flex-col gap-3 animate-in fade-in zoom-in-95 duration-150",
          )}
          style={{
          ...
          {showInput && (
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className={cn(
                  "flex-1 px-2 py-1 text-sm font-mono rounded-lg border",
                  borderColor,
