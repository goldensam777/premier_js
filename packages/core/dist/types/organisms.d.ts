...
export type SiteBlog = Organism & {
    kind: "SiteBlog";
    pages: (PageContenu & {
        purpose: "BlogListPage" | "BlogPostPage";
    })[];
};
...
export type SitePortfolio = Organism & {
    kind: "SitePortfolio";
    pages: (PageVitrine & {
        purpose: "PortfolioPage" | "LandingPage";
    })[];
};
...
export type SiteEcommerce = Organism & {
    kind: "SiteEcommerce";
    pages: ((PageVitrine & {
        purpose: "LandingPage" | "ProductPage";
    }) | (PageApplicative & {
        purpose: "DashboardPage";
    }))[];
};
...
export type SiteVitrine = Organism & {
    kind: "SiteVitrine";
    pages: (PageVitrine & {
        purpose: "LandingPage" | "PortfolioPage";
    })[];
};
export type Site = SiteBlog | SiteSaas | SitePortfolio | SiteResearchLab | SiteEcommerce | SiteChatApp | SiteVitrine;
